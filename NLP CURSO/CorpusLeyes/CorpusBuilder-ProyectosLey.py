...
def PreprocessingEspecial(cadena, stop_words):
...
texto = []
pg_amount = 1 #Número de páginas visitadas
...
for i in range(1, pg_amount+1):    
    for row in tables[2].findAll("tr"):
        ...
        if(texto!=[]):
            ...
            leyes,articulos,urgencias,legislativos,supremos = PreprocessingEspecial(cadena, spanish_stop_words)
